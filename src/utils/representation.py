...
class PromptRepresentation(BaseModel):
    ...
    explicit: list[ExplicitObservationBase] = Field(
        description=(
            "Durable facts LITERALLY stated by the user - direct quotes or clear paraphrases only, "
            "no interpretation or inference. Exclude temporary task status, requests for help, "
            "open questions, uncertain plans, and duplicates. Example: ['The user is 25 years old', "
